...
Add your API_KEY as an environment variable in the Vercel project settings.
Click Deploy. Vercel will automatically use the vercel.json file to build and deploy the application. =======
NeuroBright
